...
export function useWebSocket() {
  ...
  const connect = useCallback(() => {
    ...
    newSocket.on('user:typing', ({ userId, userName, username, conversationId, isTyping }) => {
      ...
      console.log('[WS] user:typing received', { userId, displayName, conversationId, isTyping });
    ...
    newSocket.on('sentiment:group', (data) => {
      console.log('📊 Group sentiment update:', data);
    ...
    newSocket.on('sentiment:message', (data) => {
      console.log('📊 Message sentiment:', data);
    ...
    newSocket.on('moderation:unlocked', (data) => {
      console.log('🔓 Group unlocked:', data);
      const { conversationId } = data;
      if (conversationId) {
        setGroupLocked(prev => {
          const next = { ...prev };
    ...
    newSocket.on('moderation:reset', (data) => {
      console.log('🔄 Moderation reset:', data);
      const { conversationId } = data;
      if (conversationId) {
